    ...
    <div className="flex flex-col  items-center justify-center h-screen">
      ...
      <header className="flex w-full p-5 justify-between text-sm text-gray-700">
        ...
        <div className="flex space-x-4 items-center">
          ...
          {/* Avatar */}
          <Avatar url="https://pbs.twimg.com/profile_images/1252876564376678400/dB50P2aP_400x400.jpg" />
        </div>
      </header>
      ...
      <form className="flex flex-col items-center mt-24 flex-grow w-4/5">
        ...
        <div
          className="flex flex-col w-1/2 space-y-2 justify-center mt-8 mb-4 sm:space-y-0
